...
class SAC(object):
    ...
    def select_action(self, state, batched=False, evaluate=False, numpy=True):
    ...
    def load_checkpoint(self, ckpt_path, evaluate=False, map_location=None):
